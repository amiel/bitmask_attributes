...
class BitmaskAttributeGenerator
  ...
  def generate
    # unless @base_class.new.respond_to? @field_name
    #   @base_class.logger.error("BitmaskAttributes: #{@base_class}##{@mask_name} is expecting a field in your database named #{@field_name}")
    # end
